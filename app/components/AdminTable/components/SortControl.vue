<i18n src="./SortControl.json"></i18n>
...
const sortOptions = defineModel<{ field: string, order: string }[]>('model', { default: [] })
...
<template>
  ...
  >
    <UButton
      ...
      size="sm"
    >
      {{ t('sortControl.sort') }} <span class="ml-1">{{ sortOptions.length }}</span>
    </UButton>
    <template #content>
